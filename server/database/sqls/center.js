...
from center 
where center_no=?`;
const searchAllCenter = `select center_no,center_name,replace(center_address,'|','') as center_address,center_tel,center_email,center_status,center_end,center_lunch from center where ?? like concat('%', ?, '%')`;
